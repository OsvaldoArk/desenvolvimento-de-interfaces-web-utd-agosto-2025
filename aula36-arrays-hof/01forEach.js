...
pessoas.forEach((pessoa,indice)=>{
    ...
    console.log("data de nascimento: ",pessoa.dataNascimento.split("-").reverse().join("/"));
    console.log("=================================");
});

pessoas.forEach(({nome,peso,altura,dataNascimento})=>{
    console.log("nome: ",nome);
    console.log("peso: ",peso);
    console.log("altura: ",altura);
    console.log("data de nascimento: ",dataNascimento.split("-").reverse().join("/"));
    console.log("=================================");
});